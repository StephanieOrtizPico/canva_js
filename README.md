...
- El elemento Canvas, junto al lenguaje JS nos permite crear animaciones y juegos 2s en el navegador.
...
- Alternativas:
    ...
    - Utilizar un detector de eventos que nos indique cuando los elementos han sido creados. (evento onload desde el body o scrit)
